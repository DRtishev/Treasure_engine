...
const fixtureRows = [
  { provider_id: 'bybit_ws_v5', symbol: 'BTCUSDT', side: 'Sell', ts: 1735689600000, p: '43000', v: '12', topic: 'liquidation.BTCUSDT' },
  { provider_id: 'bybit_ws_v5', symbol: 'BTCUSDT', side: 'Buy', ts: 1735689601000, p: '43010', v: '4', topic: 'liquidation.BTCUSDT' },
  { provider_id: 'bybit_ws_v5', symbol: 'ETHUSDT', side: 'Sell', ts: 1735689602000, p: '2400', v: '20', topic: 'liquidation.ETHUSDT' },
];
...
const normalized = { provider_id: 'bybit_ws_v5', schema_version: 'liquidations.bybit_ws_v5.v1', time_unit_sentinel: 'ms', rows: fixtureRows };
const lock = { provider_id: 'bybit_ws_v5', schema_version: 'liquidations.bybit_ws_v5.v1', time_unit_sentinel: 'ms', raw_capture_sha256: sha(raw), normalized_schema_sha256: sha(JSON.stringify(canon(normalized))), captured_at_utc: 'VOLATILE' };
