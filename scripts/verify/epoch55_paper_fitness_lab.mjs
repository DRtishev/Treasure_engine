...
const r1 = runPaperFitnessLab({ seed: 5501 });
const r2 = runPaperFitnessLab({ seed: 5501 });
...
fs.writeFileSync(path.resolve('reports/fitness/epoch55_frontier.json'), JSON.stringify(r1, null, 2) + '\n');
