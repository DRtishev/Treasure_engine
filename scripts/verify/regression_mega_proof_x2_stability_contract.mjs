...
const status = hasDeterministicGzip && hasNd01DiffHint ? 'PASS' : 'FAIL';
...
writeJsonDeterministic(path.join(MANUAL_DIR, 'regression_mega_proof_x2_stability_contract.json'), {
  ...
  next_action: NEXT_ACTION, has_deterministic_gzip: hasDeterministicGzip, has_nd01_diff_hint: hasNd01DiffHint,
});
