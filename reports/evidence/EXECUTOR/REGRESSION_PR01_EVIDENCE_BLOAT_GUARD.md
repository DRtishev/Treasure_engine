...
## OFFENDERS
- reports/evidence/EPOCH-V2-S4-AUDIT/AUDIT_SPRINT_4_ND_EXORCISM.md
- reports/evidence/EPOCH-V2-S5B-AUDIT/AUDIT_AFTER_SPRINT_5B.md
- reports/evidence/EPOCH-V2-S6-AUDIT/AUDIT_SPRINT_6_DOCTOR_LIVENESS.md
...
- reports/evidence/EXECUTOR/DOCTOR_HISTORY.jsonl
- reports/evidence/EXECUTOR/DRYRUN_LIVE_E2E_V2.md
...
- reports/evidence/EXECUTOR/gates/manual/dryrun_live_e2e_v2.json
...
- reports/evidence/EXECUTOR/gates/manual/regression_profit_e2e_ks01.json
- reports/evidence/EXECUTOR/gates/manual/regression_profit_e2e_sizer01.json
...
- reports/evidence/EXECUTOR/gates/manual/regression_toolchain_reason01_classification.json
- reports/evidence/EXECUTOR/gates/manual/regression_toolchain_reason02_detail_required.json
- reports/evidence/EXECUTOR/gates/manual/regression_unlock01.json
...
- reports/evidence/EXECUTOR/REGRESSION_PROFIT_E2E_KS01.md
- reports/evidence/EXECUTOR/REGRESSION_PROFIT_E2E_SIZER01.md
