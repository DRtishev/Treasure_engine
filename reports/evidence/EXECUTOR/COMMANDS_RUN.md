## source ~/.nvm/nvm.sh && nvm install 22.22.0 && nvm use 22.22.0 >/dev/null && node -v
```
- ec: 0
- output: Downloading and installing node v22.22.0...
  ...
  npm install -g --quiet prettier eslint typescript
...
## source ~/.nvm/nvm.sh && nvm use 22.22.0 >/dev/null && npm -v
```
- ec: 0
- output: 10.9.4
```

## source ~/.nvm/nvm.sh && nvm use 22.22.0 >/dev/null && npm run -s verify:env:authority
```
- ec: 0
- output: [PASS] env_node_truth_authority — NONE
```

## source ~/.nvm/nvm.sh && nvm use 22.22.0 >/dev/null && ENABLE_SQLITE_PERSISTENCE=0 TREASURE_OMIT_OPTIONAL_PROOF=1 npm ci --omit=optional
```
- ec: 0
- output: 
...
## source ~/.nvm/nvm.sh && nvm use 22.22.0 >/dev/null && npm run -s p0:all
```
- ec: 0
- output: 
  ============================================================
  ...
  [PASS] edge_receipts_chain — 115 entries chained, final=0cb69e38613a67cc...
  ...
  [PASS] verify_mode_gate — VERIFY_MODE=GIT, RUN_ID=b455ad077aff
...
## source ~/.nvm/nvm.sh && nvm use 22.22.0 >/dev/null && npm run -s gov:gov01
```
- ec: 0
- output: 
  ============================================================
  ...
  [GOV01] Anchored MERKLE_ROOT: a91446a84476e375…
  [GOV01] Anchored RECEIPTS final: 0cb69e38613a67cc…
  [GOV01] Computed SCOPE_MANIFEST_SHA: a202ce963b6330f5…
  [GOV01] Computed MERKLE_ROOT: a91446a84476e375…
  [GOV01] Computed RECEIPTS final: 0cb69e38613a67cc…
...
## source ~/.nvm/nvm.sh && nvm use 22.22.0 >/dev/null && npm run -s gov:integrity
```
- ec: 0
- output: 
  ============================================================
  ...
  [MERKLE] Tree depth: 8
  [MERKLE] Root: a91446a84476e375742f0fbd6aaaa44cb6729dac7308d6a6a617483041a96200
  [MERKLE] SCOPE_MANIFEST_SHA: a202ce963b6330f554b6f387cb0151e60d81af24a699ae9f2c2499a978a4040f
  
  ============================================================
  P1 MERKLE ROOT RESULT
  ============================================================
    Root: a91446a84476e375742f0fbd6aaaa44cb6729dac7308d6a6a617483041a96200
    Files: 115/115 (0 missing)
    Depth: 8 levels
    Status: PASS
  ============================================================
  
  [PASS] merkle_root — Merkle root anchored at a91446a84476e375…
...
## source ~/.nvm/nvm.sh && nvm use 22.22.0 >/dev/null && npm run -s edge:profit:01:super
```
- ec: 0
- output: [PASS] env_node_truth_authority — NONE
