...
export function meta() {
  return {
    ...
    default_params: {
      liq_threshold: 0.65, burst_threshold: 2.0, atr_period: 14, atr_stop_mult: 1.5,
      rsi_period: 14, rsi_oversold: 30, rsi_overbought: 70, sma_period: 20, sma_deviation_pct: 0.02,
      vol_lookback: 20, vol_trend_thresh: 0.02, vol_crisis_thresh: 0.06,
      quality_gate: 0.65, profit_target_pct: 0.012, stop_loss_pct: 0.015, max_hold_bars: 25,
    },
