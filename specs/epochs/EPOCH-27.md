# EPOCH-27 — AI Contracts + Deterministic Harness

## REALITY SNAPSHOT
- Implementation epoch with executable verification gate and evidence outputs.

## GOALS
- Record authoritative contract and acceptance criteria for EPOCH-27.
...
- Dependencies: EPOCH-24, EPOCH-25, EPOCH-26.
- Primary owner gate: `verify:epoch27`.
