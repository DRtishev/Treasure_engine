# EPOCH-42 — Execution Realism Hardening

## REALITY SNAPSHOT
- Current state: Stage-2 bridge/planning required after E40 closeout.
- Dependency baseline: EPOCH-41.
- Evidence root for this epoch: `reports/evidence/EPOCH-42/`.

## GOALS
- Implement execution realism contracts from bridge findings.
- Add falsifiable calibration gates for slippage/latency/partial-fill realism.
- Promote only after two-run deterministic evidence.
...
- Gate logs under `reports/evidence/EPOCH-42/gates/` or equivalent.
