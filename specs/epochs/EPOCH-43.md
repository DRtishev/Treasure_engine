# EPOCH-43 — Overfit Defense: CPCV + PBO + DSR

## REALITY SNAPSHOT
- Current state: Stage-2 bridge/planning required after E40 closeout.
- Dependency baseline: EPOCH-42.
- Evidence root for this epoch: `reports/evidence/EPOCH-43/`.

## GOALS
- Implement CPCV/PBO/DSR checks in reproducible harnesses.
- Add anti-overfit release gate requirements.
- Persist fold manifests and overfit diagnostics.
...
- Gate logs under `reports/evidence/EPOCH-43/gates/` or equivalent.
...
## NOTES
Planned Stage-2 robustness epoch.
