# WOW-22 Anti-Blowup Shield: Drawdown-Conditional Dynamic Sizing (MOONSHOT)

## Mechanism
Anti-Blowup Shield: Drawdown-Conditional Dynamic Sizing (MOONSHOT) improves decision quality through deterministic implemented controls.
